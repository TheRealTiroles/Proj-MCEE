classdef Renderer < handle
    ...
    methods 
        ...
        function SetupPlayerNameInterface(this)
            this.SetupFigure('Inserir Nome', @(src, event) this.Game_.InputHandler_.TecladoCallback(src, event));
            
            this.Eixos_ = axes('Parent', this.Fig_, 'Visible', 'off');
            set(this.Fig_, 'CurrentAxes', this.Eixos_);
        end
        
        function DrawGetPlayerName(this)
            cla(this.Eixos_);
            this.Eixos_ = axes('Parent', this.Fig_, 'Position', [0 0 1 1]);
            set(this.Eixos_, 'XLim', [0 1], 'YLim', [0 1]);
            axis(this.Eixos_, 'off');
            
            uistack(this.Eixos_, 'top');
            
            rectangle(this.Eixos_, 'Position', [0, 0, 1, 1], ...
                'FaceColor', [0, 0, 0], 'EdgeColor', 'none', 'FaceAlpha', 0.7);
            
            text(0.5, 0.75, 'INSIRA SEU NOME', ...
                'Parent', this.Eixos_, ...
                'FontSize', 50, ...
                'FontWeight', 'bold', ...
                'Color', [1 0.5 0], ...
            ...
            inputText = this.Game_.InputString_;
            if isempty(inputText)
                inputText = '_';
            end
            text(0.5, 0.55, inputText, ...
                'Parent', this.Eixos_, ...
                'FontSize', 40, ...
                'FontWeight', 'bold', ...
                'Color', [1 1 1], ...
            ...
            text(0.5, 0.30, 'Pressione ENTER para confirmar', ...
                'Parent', this.Eixos_, ...
                'FontSize', 18, ...
                'Color', [1 1 1], ...
                'HorizontalAlignment', 'center', ...
            ...
            text(0.5, 0.20, 'ou BACKSPACE para deletar', ...
                'Parent', this.Eixos_, ...
                'FontSize', 16, ...
                'Color', [0.8 0.8 0.8], ...
                'HorizontalAlignment', 'center', ...
       ...
       function DrawGame(this)
        ...
        function DrawGameOver(this)
            ...
            nameText = sprintf(['Player: ' this.Game_.PlayerName_]);
            text(0.5, 0.50, nameText, ...
                'Parent', this.EixosAux_, ...
                'FontSize', 25, ...
                'FontWeight', 'bold', ...
                'Color', [1 0 0], ...
            ...
            scoreText = sprintf('Pontuação Final: %d pts.', this.Game_.Score_);
            text(0.5, 0.45, scoreText, ...
                'Parent', this.EixosAux_, ...
                'FontSize', 15, ...
                'FontWeight', 'bold', ...
                'Color', [1 1 0], ...
            ...
            difficultyText = sprintf(['Difficulty: ' dificuldades{this.Game_.SettingsDifficulty_}]);
            text(0.5, 0.40, difficultyText, ...
                'Parent', this.EixosAux_, ...
                'FontSize', 15, ...
                'FontWeight', 'bold', ...
                'Color', [1 1 0], ...
            ...
            text(0.5, 0.20, 'Pressione ENTER para voltar ao Menu', ...
                'Parent', this.EixosAux_, ...
                'FontSize', 14, ...
                'Color', [1 1 1], ...
                'HorizontalAlignment', 'center', ...
            ...
            text(0.5, 0.17, 'ou ESC para sair', ...
                'Parent', this.EixosAux_, ...
                'FontSize', 12, ...
                'Color', [0.8 0.8 0.8], ...
                'HorizontalAlignment', 'center', ...
